...
export const metadata: Metadata = {
  title: 'Border Trade & Logistics AI Automation New Mexico | Industry Solutions | RJ Business Solutions',
  description: 'Cross-border commerce and international trade automation in New Mexico. Serving 420+ border trade & logistics businesses with specialized AI automation and digital transformation.',
  keywords: 'border trade & logistics AI New Mexico, border-trade automation, New Mexico border trade & logistics, industry AI solutions',
  openGraph: {
    title: 'Border Trade & Logistics AI Automation New Mexico | RJ Business Solutions',
    description: 'Cross-border commerce and international trade automation across New Mexico.',
    url: 'https://rjbusinesssolutions.org/industries/border-trade-ai-new-mexico',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/industries/border-trade-ai-new-mexico'
  }
};

export default function BorderTradeLogisticsAINewMexico() {
  return (
    <>
      <Script
        id="structured-data-border-trade-nm"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "RJ Business Solutions - Border Trade & Logistics AI New Mexico",
          "description": "Cross-border commerce and international trade automation",
          "areaServed": {
            "@type": "State",
            "name": "New Mexico"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Border Trade & Logistics AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-indigo-100">
              Cross-border commerce and international trade automation
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 420+ border trade & logistics businesses across New Mexico with specialized AI automation
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-indigo-600 mb-2">420+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              Border Trade & Logistics AI Automation Solutions
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized solutions for New Mexico's border trade & logistics sector
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for border trade & logistics businesses with industry-specific knowledge and workflows.
                    </p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline border trade & logistics operations with intelligent workflow automation and business process optimization.
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Transform Your Border Trade & Logistics Business with AI
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join New Mexico border trade & logistics businesses that have automated operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
