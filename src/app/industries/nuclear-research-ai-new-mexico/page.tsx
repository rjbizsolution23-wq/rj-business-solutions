...
export const metadata: Metadata = {
  title: 'Nuclear & Research AI Automation New Mexico | Industry Solutions | RJ Business Solutions',
  description: 'National laboratory automation and scientific research tools in New Mexico. Serving 180+ nuclear & research businesses with specialized AI automation and digital transformation.',
  keywords: 'nuclear & research AI New Mexico, nuclear-research automation, New Mexico nuclear & research, industry AI solutions',
  openGraph: {
    title: 'Nuclear & Research AI Automation New Mexico | RJ Business Solutions',
    description: 'National laboratory automation and scientific research tools across New Mexico.',
    url: 'https://rjbusinesssolutions.org/industries/nuclear-research-ai-new-mexico',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/industries/nuclear-research-ai-new-mexico'
  }
};

export default function NuclearResearchAINewMexico() {
  return (
    <>
      <Script
        id="structured-data-nuclear-research-nm"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "RJ Business Solutions - Nuclear & Research AI New Mexico",
          "description": "National laboratory automation and scientific research tools",
          "areaServed": {
            "@type": "State",
            "name": "New Mexico"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Nuclear & Research AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-indigo-100">
              National laboratory automation and scientific research tools
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 180+ nuclear & research businesses across New Mexico with specialized AI automation
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              Nuclear & Research AI Automation Solutions
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized solutions for New Mexico's nuclear & research sector
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for nuclear & research businesses with industry-specific knowledge and workflows.
                    </p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline nuclear & research operations with intelligent workflow automation and business process optimization.
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Transform Your Nuclear & Research Business with AI
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join New Mexico nuclear & research businesses that have automated operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
