...
export const metadata: Metadata = {
  title: 'Financial Services AI Automation Texas | Industry Solutions | RJ Business Solutions',
  description: 'Banking automation, fintech solutions, and regulatory compliance in Texas. Serving 8,900+ financial services businesses with specialized AI automation and digital transformation.',
  keywords: 'financial services AI Texas, financial-services automation, Texas financial services, industry AI solutions',
  openGraph: {
    title: 'Financial Services AI Automation Texas | RJ Business Solutions',
    description: 'Banking automation, fintech solutions, and regulatory compliance across Texas.',
    url: 'https://rjbusinesssolutions.org/industries/financial-services-ai-texas',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/industries/financial-services-ai-texas'
  }
};

export default function FinancialServicesAITexas() {
  return (
    <>
      <Script
        id="structured-data-financial-services-tx"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "RJ Business Solutions - Financial Services AI Texas",
          "description": "Banking automation, fintech solutions, and regulatory compliance",
          "areaServed": {
            "@type": "State",
            "name": "Texas"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-4 text-indigo-100">
              Banking automation, fintech solutions, and regulatory compliance
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 8,900+ financial services businesses across Texas with specialized AI automation
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              Financial Services AI Automation Solutions
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized solutions for Texas's financial services sector
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for financial services businesses with industry-specific knowledge and workflows.
                    </p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline financial services operations with intelligent workflow automation and business process optimization.
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Transform Your Financial Services Business with AI
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join Texas financial services businesses that have automated operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
