...
export const metadata: Metadata = {
  title: 'Aerospace & Defense AI Automation Texas | Industry Solutions | RJ Business Solutions',
  description: 'Aviation automation, defense systems, and space technology in Texas. Serving 3,400+ aerospace & defense businesses with specialized AI automation and digital transformation.',
  keywords: 'aerospace & defense AI Texas, aerospace-defense automation, Texas aerospace & defense, industry AI solutions',
  openGraph: {
    title: 'Aerospace & Defense AI Automation Texas | RJ Business Solutions',
    description: 'Aviation automation, defense systems, and space technology across Texas.',
    url: 'https://rjbusinesssolutions.org/industries/aerospace-defense-ai-texas',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/industries/aerospace-defense-ai-texas'
  }
};

export default function AerospaceDefenseAITexas() {
  return (
    <>
      <Script
        id="structured-data-aerospace-defense-tx"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "RJ Business Solutions - Aerospace & Defense AI Texas",
          "description": "Aviation automation, defense systems, and space technology",
          "areaServed": {
            "@type": "State",
            "name": "Texas"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-4 text-indigo-100">
              Aviation automation, defense systems, and space technology
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 3,400+ aerospace & defense businesses across Texas with specialized AI automation
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-indigo-600 mb-2">3,400+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized solutions for Texas's aerospace & defense sector
            </p>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join Texas aerospace & defense businesses that have automated operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
