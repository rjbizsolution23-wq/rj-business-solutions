...
export const metadata: Metadata = {
  title: 'Government AI Solutions AI Automation New Mexico | Industry Solutions | RJ Business Solutions',
  description: 'Citizen services, permit processing, and public administration automation in New Mexico. Serving 1,200+ government ai solutions businesses with specialized AI automation and digital transformation.',
  keywords: 'government ai solutions AI New Mexico, government automation, New Mexico government ai solutions, industry AI solutions',
  openGraph: {
    title: 'Government AI Solutions AI Automation New Mexico | RJ Business Solutions',
    description: 'Citizen services, permit processing, and public administration automation across New Mexico.',
    url: 'https://rjbusinesssolutions.org/industries/government-ai-new-mexico',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/industries/government-ai-new-mexico'
  }
};

export default function GovernmentAISolutionsAINewMexico() {
  return (
    <>
      <Script
        id="structured-data-government-nm"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "RJ Business Solutions - Government AI Solutions AI New Mexico",
          "description": "Citizen services, permit processing, and public administration automation",
          "areaServed": {
            "@type": "State",
            "name": "New Mexico"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Government AI Solutions AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-indigo-100">
              Citizen services, permit processing, and public administration automation
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 1,200+ government ai solutions businesses across New Mexico with specialized AI automation
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              Government AI Solutions AI Automation Solutions
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized solutions for New Mexico's government ai solutions sector
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for government ai solutions businesses with industry-specific knowledge and workflows.
                    </p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline government ai solutions operations with intelligent workflow automation and business process optimization.
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Transform Your Government AI Solutions Business with AI
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join New Mexico government ai solutions businesses that have automated operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
