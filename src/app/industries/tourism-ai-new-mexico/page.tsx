...
export const metadata: Metadata = {
  title: 'Tourism & Hospitality AI AI Automation New Mexico | Industry Solutions | RJ Business Solutions',
  description: 'Hotel management, visitor services, and tourism marketing automation in New Mexico. Serving 2,100+ tourism & hospitality ai businesses with specialized AI automation and digital transformation.',
  keywords: 'tourism & hospitality ai AI New Mexico, tourism automation, New Mexico tourism & hospitality ai, industry AI solutions',
  openGraph: {
    title: 'Tourism & Hospitality AI AI Automation New Mexico | RJ Business Solutions',
    description: 'Hotel management, visitor services, and tourism marketing automation across New Mexico.',
    url: 'https://rjbusinesssolutions.org/industries/tourism-ai-new-mexico',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/industries/tourism-ai-new-mexico'
  }
};

export default function TourismHospitalityAIAINewMexico() {
  return (
    <>
      <Script
        id="structured-data-tourism-nm"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "ProfessionalService",
          "name": "RJ Business Solutions - Tourism & Hospitality AI AI New Mexico",
          "description": "Hotel management, visitor services, and tourism marketing automation",
          "areaServed": {
            "@type": "State",
            "name": "New Mexico"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Tourism & Hospitality AI AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-indigo-100">
              Hotel management, visitor services, and tourism marketing automation
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 2,100+ tourism & hospitality ai businesses across New Mexico with specialized AI automation
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-indigo-600 mb-2">2,100+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              Tourism & Hospitality AI AI Automation Solutions
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized solutions for New Mexico's tourism & hospitality ai sector
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for tourism & hospitality ai businesses with industry-specific knowledge and workflows.
                    </p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline tourism & hospitality ai operations with intelligent workflow automation and business process optimization.
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Transform Your Tourism & Hospitality AI Business with AI
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join New Mexico tourism & hospitality ai businesses that have automated operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
