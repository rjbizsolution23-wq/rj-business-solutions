...
export const metadata: Metadata = {
  title: 'AI Business Automation Indian Creek FL | Ultra-Luxury Solutions | RJ Business Solutions',
  description: 'Leading AI automation expert in Indian Creek, Florida. Custom solutions for ultra-luxury businesses in the Miami metro area. Local expertise with enterprise results.',
  keywords: 'AI automation Indian Creek, business automation Indian Creek FL, ultra-luxury AI solutions, Miami metro AI services',
  openGraph: {
    title: 'AI Business Automation Indian Creek FL | RJ Business Solutions',
    description: 'Transform your Indian Creek business with AI automation. Serving ultra-luxury in Miami metro.',
    url: 'https://rjbusinesssolutions.org/locations/indian-creek-fl',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/locations/indian-creek-fl'
  }
};

export default function IndianCreekAIAutomation() {
  return (
    <>
      <Script
        id="structured-data-indian-creek"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "RJ Business Solutions - Indian Creek AI Automation",
          "address": {
            "@type": "PostalAddress",
            "addressLocality": "Indian Creek",
            "addressRegion": "FL",
            "addressCountry": "US"
          },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <span className="text-xl text-green-200">Indian Creek, Florida</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Indian Creek AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-green-100">
              Ultra-Luxury Automation in Miami Metro
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 12+ Indian Creek businesses with specialized AI automation
              for ultra-luxury in the greater Miami metropolitan area
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                Call Indian Creek: (877) 561-8001
              </a>
              <Link
                href="#services"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              AI Solutions for Indian Creek Businesses
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized automation for ultra-luxury in Miami metro area
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for Indian Creek ultra-luxury businesses 
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline Indian Creek ultra-luxury operations with intelligent 
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Automate Your Indian Creek Business?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join Indian Creek ultra-luxury businesses leveraging AI automation in Miami metro
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
            ...
            >
              Schedule Indian Creek Consultation
            </Link>
          </div>
        </div>
      </section>
