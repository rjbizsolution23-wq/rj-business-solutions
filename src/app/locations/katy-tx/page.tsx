...
export const metadata: Metadata = {
  title: 'AI Business Automation Katy TX | Energy & Family Solutions | RJ Business Solutions',
  description: 'Leading AI automation expert in Katy, Texas. Custom solutions for energy & family businesses in the Houston metro area. Local expertise with enterprise results.',
  keywords: 'AI automation Katy, business automation Katy TX, energy & family AI solutions, Houston metro AI services',
  openGraph: {
    title: 'AI Business Automation Katy TX | RJ Business Solutions',
    description: 'Transform your Katy business with AI automation. Serving energy & family in Houston metro.',
    url: 'https://rjbusinesssolutions.org/locations/katy-tx',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/locations/katy-tx'
  }
};

export default function KatyAIAutomation() {
  return (
    <>
      <Script
        id="structured-data-katy"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "RJ Business Solutions - Katy AI Automation",
          "address": {
            "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <span className="text-xl text-green-200">Katy, Texas</span>
            </div>
            ...
            <p className="text-lg mb-8 text-gray-200">
              Serving 3,200+ Katy businesses with specialized AI automation
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-green-600 mb-2">21,894</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              AI Solutions for Katy Businesses
            </h2>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for Katy energy & family businesses 
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline Katy energy & family operations with intelligent 
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Automate Your Katy Business?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join Katy energy & family businesses leveraging AI automation in Houston metro
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
