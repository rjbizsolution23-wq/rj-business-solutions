...
export const metadata: Metadata = {
  title: 'AI Business Automation League City TX | Aerospace & Energy Solutions | RJ Business Solutions',
  description: 'Leading AI automation expert in League City, Texas. Custom solutions for aerospace & energy businesses in the Houston metro area. Local expertise with enterprise results.',
  keywords: 'AI automation League City, business automation League City TX, aerospace & energy AI solutions, Houston metro AI services',
  openGraph: {
    title: 'AI Business Automation League City TX | RJ Business Solutions',
    description: 'Transform your League City business with AI automation. Serving aerospace & energy in Houston metro.',
    url: 'https://rjbusinesssolutions.org/locations/league-city-tx',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/locations/league-city-tx'
  }
};

export default function LeagueCityAIAutomation() {
  return (
    <>
      <Script
        id="structured-data-league-city"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "RJ Business Solutions - League City AI Automation",
          "address": {
            "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <span className="text-xl text-green-200">League City, Texas</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              League City AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-green-100">
              Aerospace & Energy Automation in Houston Metro
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 6,500+ League City businesses with specialized AI automation
              for aerospace & energy in the greater Houston metropolitan area
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-green-600 mb-2">114,424</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              AI Solutions for League City Businesses
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized automation for aerospace & energy in Houston metro area
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for League City aerospace & energy businesses 
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline League City aerospace & energy operations with intelligent 
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Automate Your League City Business?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join League City aerospace & energy businesses leveraging AI automation in Houston metro
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
            ...
            >
              Schedule League City Consultation
            </Link>
          </div>
        </div>
      </section>
