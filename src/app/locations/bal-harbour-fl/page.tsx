...
export const metadata: Metadata = {
  title: 'AI Business Automation Bal Harbour FL | Luxury & Tourism Solutions | RJ Business Solutions',
  description: 'Leading AI automation expert in Bal Harbour, Florida. Custom solutions for luxury & tourism businesses in the Miami metro area. Local expertise with enterprise results.',
  keywords: 'AI automation Bal Harbour, business automation Bal Harbour FL, luxury & tourism AI solutions, Miami metro AI services',
  openGraph: {
    title: 'AI Business Automation Bal Harbour FL | RJ Business Solutions',
    description: 'Transform your Bal Harbour business with AI automation. Serving luxury & tourism in Miami metro.',
    url: 'https://rjbusinesssolutions.org/locations/bal-harbour-fl',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/locations/bal-harbour-fl'
  }
};

export default function BalHarbourAIAutomation() {
  return (
    <>
      <Script
        id="structured-data-bal-harbour"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "RJ Business Solutions - Bal Harbour AI Automation",
          "address": {
            "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <span className="text-xl text-green-200">Bal Harbour, Florida</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Bal Harbour AI Solutions
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-green-100">
              Luxury & Tourism Automation in Miami Metro
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 420+ Bal Harbour businesses with specialized AI automation
              for luxury & tourism in the greater Miami metropolitan area
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-green-600 mb-2">3,093</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              AI Solutions for Bal Harbour Businesses
            </h2>
            <p className="text-xl text-center text-gray-600 mb-12">
              Specialized automation for luxury & tourism in Miami metro area
            </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots designed for Bal Harbour luxury & tourism businesses 
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline Bal Harbour luxury & tourism operations with intelligent 
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Automate Your Bal Harbour Business?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join Bal Harbour luxury & tourism businesses leveraging AI automation in Miami metro
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
            ...
            >
              Schedule Bal Harbour Consultation
            </Link>
          </div>
        </div>
      </section>
