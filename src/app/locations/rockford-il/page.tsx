...
export const metadata: Metadata = {
  title: 'AI Business Automation Rockford IL | Manufacturing & Healthcare Solutions | RJ Business Solutions',
  description: 'Leading AI automation expert in Rockford, Illinois. Custom chatbots, process automation, and digital transformation for manufacturing & healthcare businesses. 24/7 support.',
  keywords: 'AI automation Rockford, business automation Rockford IL, manufacturing & healthcare AI solutions, chatbot services Rockford',
  openGraph: {
    title: 'AI Business Automation Rockford IL | RJ Business Solutions',
    description: 'Transform your Rockford business with AI automation. Serving manufacturing & healthcare industry with custom solutions.',
    url: 'https://rjbusinesssolutions.org/locations/rockford-il',
    siteName: 'RJ Business Solutions',
    locale: 'en_US',
    type: 'website',
  },
  alternates: {
    canonical: 'https://rjbusinesssolutions.org/locations/rockford-il'
  }
};
...
export default function RockfordAIAutomation() {
  return (
    <>
      <Script
        id="structured-data-rockford"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "LocalBusiness",
          "name": "RJ Business Solutions - Rockford AI Automation Hub",
          "address": {
            "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <span className="text-xl text-blue-200">Rockford, Illinois</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Rockford AI Automation Hub
            </h1>
            <p className="text-xl md:text-2xl mb-4 text-blue-100">
              Manufacturing & Healthcare Digital Transformation & AI Solutions
            </p>
            <p className="text-lg mb-8 text-gray-200">
              Serving 8,500+ Rockford businesses with cutting-edge AI automation,
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="text-3xl font-bold text-blue-600 mb-2">148,655</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">
              AI Solutions for Rockford Businesses
            </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold mb-3">AI Chatbots for Rockford</h3>
                    <p className="text-gray-600 mb-4">
                      Custom AI chatbots that understand your Rockford customers and manufacturing & healthcare industry needs.
                    </p>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-4">
                      Streamline your Rockford manufacturing & healthcare operations with intelligent automation and workflow optimization.
                    </p>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">
            Ready to Automate Your Rockford Business?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join successful Rockford businesses that have transformed operations with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:8775618001"
      ...
      <section className="py-8 bg-gray-100 text-sm">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-gray-600">
            <p>
              <strong>RJ Business Solutions Rockford</strong> - AI automation hub serving Rockford, Illinois since 2020
            </p>
          </div>
        </div>
      </section>
