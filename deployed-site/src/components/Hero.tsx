        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              <strong>Free demo. See results in real-time. No obligation.</strong> Led by Rick Jefferson, AI Systems Architect, delivering production-grade solutions across New Mexico and nationwide.
            </p>
